...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const fullVersion = core.getInput('full-version');
            const manifestFilePath = core.getInput('manifest-file-path');
            let updatedAtTime = core.getInput('updated-at-time');
            let releaseGithubUrl = core.getInput('release-github-url');
            const releaseBoothUrl = core.getInput('release-booth-url');
            ...
            const manifestFullFilePath = path_1.default.join(wsPath, manifestFilePath);
            let manifestJsonStr = fs_1.default.readFileSync(manifestFullFilePath).toString('utf8');
            ;
            let manifestJson = JSON.parse(manifestJsonStr);
            ...
            fs_1.default.writeFileSync(manifestFullFilePath, newJsonStr);
        }
        catch (error) {
